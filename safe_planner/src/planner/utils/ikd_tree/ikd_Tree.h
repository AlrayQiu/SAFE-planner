...
private:
    ...
    void Search_by_range(KD_TREE_NODE *root, BoxPointType boxpoint, PointVector &Storage, bool lock_handled = false);
    void Search_by_radius(KD_TREE_NODE *root, PointType point, float radius, PointVector &Storage, bool lock_handled = false);
...
public:
    ...
    bool Nearest_Search(const PointType& point, PointType &Nearest_Points, double max_dist = INFINITY);
    ...
    void Add_Point(const PointType& PointToAdd);
